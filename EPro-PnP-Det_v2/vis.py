...
# import json
# with open("/simplstor/ypatel/workspace/EPro-PnP-v2/EPro-PnP-Det_v2/data/int_3/merged_train_1.json", "r") as f19:
#     data19 = json.load(f19)
# with open("/simplstor/ypatel/workspace/EPro-PnP-v2/EPro-PnP-Det_v2/data/int_3/train_cam_aug.json", "r") as f20:
#     data20 = json.load(f20)

# merged_data = {"frames": data19["frames"] + 
#                data20["frames"]}

# with open(os.path.join("/simplstor/ypatel/workspace/EPro-PnP-v2/EPro-PnP-Det_v2/data/int_3", "cam_aug.json"), "w") as f:
...
def convert_png_to_jpg(folder_path, delete_original=False):
    for filename in os.listdir(folder_path):
        if filename.lower().endswith(".png"):
            ...
            try:
                img = Image.open(file_path).convert("RGB")  # convert to RGB to avoid alpha issues
...
# Example usage
convert_png_to_jpg("/simplstor/ypatel/datasets/KITTI/rendered_images", delete_original=True)