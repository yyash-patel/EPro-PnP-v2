model = dict(
    ...
    test_cfg=dict(
        ...
        nms_ioubev_thr=0.25))
dataset_type = 'nuscenes_syn'
data_root = '/simplstor/ypatel/datasets/NUSCENES_ONE/rendered_images'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(type='Crop3DInt', crop_box=(0, 228, 900, 1600)),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='nuscene_one_synthetic.json',
        pipeline=train_pipeline,
        data_root=data_root,
        img_prefix='/simplstor/ypatel/datasets/NUSCENES_ONE/rendered_images',
