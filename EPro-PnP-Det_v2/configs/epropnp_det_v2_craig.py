...
train_pipeline = [
    ...
    dict(type='Crop3DInt', crop_box=(0, 476, 1500, 2000)),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file='craig_fifth.json',
        pipeline=train_pipeline,
        data_root=data_root,
        img_prefix='/simplstor/ypatel/workspace/EPro-PnP-v2/EPro-PnP-Det_v2/data/craig_fifth',
