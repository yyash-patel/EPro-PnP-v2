    ...
    def load_annotations(self, ann_file):
        ...
        for frame in frames:
            ...
            for j,car in enumerate(cars):
                ...
                rotationy = np.array([[1   ,   0,    0],
                        [0 ,  -1 ,   0],
                        [0 , 0  , 1]])
                rot_mat = rot_mat @ rotationy
                rot_mat[0] = -rot_mat[0]
                rot = R.from_matrix(rot_mat.copy())
                euler_deg = rot.as_euler('zxy', degrees=True)
                # print(euler_deg)
        
                # if abs(euler_deg[2])
                y_angle = 90 - euler_deg[2]
